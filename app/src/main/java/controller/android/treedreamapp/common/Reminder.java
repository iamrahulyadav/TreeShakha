...
/***************** Event: Meeting(without alert) Adding Attendies to the meeting *******************/
            ...
            Log.e("Error in adding event ","" + ex.getMessage());
        }
        return eventID;
    }
...
// Add Reminder
    ...
    public void addReminder(Activity curActivity,int statrYear, int startMonth, int startDay, int startHour, int startMinut, int endYear, int endMonth, int endDay, int endHour, int endMinuts){
